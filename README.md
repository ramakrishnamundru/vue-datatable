# vue2-material-datatable [![NPM version](https://badge.fury.io/js/vue2datatable.svg)](https://badge.fury.io/js/vue2datatable)

> A fancy datatable VueJS component
...
```javascript
import DataTable from 'vue2datatable';
```
